            ...
            >
                ...
                <div style={{ width: '100%', height: '2134px', display: 'grid', gridTemplateColumns: '1fr 1fr', gridTemplateRows: '1fr 1fr', gap: GAP_SIZE }}>
                    ...
                    <div style={{ backgroundColor: 'rgb(242, 242, 242)', width: '100%', height: '100%', position: 'relative', overflow: 'hidden' }}>
                        {backPhotos[0] && <SmartCroppedImage src={backPhotos[0]} alt="P1" className="w-full h-full object-cover" loading="eager" disableAnimation />}
                    </div>
                    ...
                    <div style={{ backgroundColor: 'rgb(242, 242, 242)', width: '100%', height: '100%', position: 'relative', overflow: 'hidden' }}>
                        {backPhotos[2] && <SmartCroppedImage src={backPhotos[2]} alt="P2" className="w-full h-full object-cover" loading="eager" disableAnimation />}
                    </div>

                    {/* ITEM 4: FOTO 3 (Abajo Derecha) */}
                    <div style={{ backgroundColor: 'rgb(242, 242, 242)', width: '100%', height: '100%', position: 'relative', overflow: 'hidden' }}>
                        {backPhotos[3] && <SmartCroppedImage src={backPhotos[3]} alt="P3" className="w-full h-full object-cover" loading="eager" disableAnimation />}
                    </div>
