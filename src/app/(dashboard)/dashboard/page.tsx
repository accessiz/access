...
function KPICardsSkeleton() {
  return (
    <div role="status" aria-label="Cargando indicadores" className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
    ...
    <div className="flex-1 overflow-y-auto py-6 pr-1">
      <div className="grid gap-6">
        ...
        <section aria-label="Resumen de proyectos">
          <h2 className="sr-only">Resumen de Proyectos</h2>
        ...
        <Suspense fallback={
          <div role="status" aria-label="Cargando rankings">
            <span className="sr-only">Cargando...</span>
