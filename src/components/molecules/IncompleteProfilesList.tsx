...
export function IncompleteProfilesList({ models }: IncompleteProfilesListProps) {
    return (
        <TooltipProvider delayDuration={200}>
            <div className="max-h-[380px] overflow-y-auto pr-2 [scrollbar-width:thin] [scrollbar-color:rgba(255,255,255,0.15)_transparent]">
                        ...
                        <li key={m.id} className="text-body first:pt-0 last:pb-0 py-3">
                            ...
                            >
                                <div className="flex items-center gap-2">
                                    <span className="text-muted-foreground/60 font-mono text-xs w-6 shrink-0 text-right mr-1">
                                        {i + 1}.
                                    </span>
                                        ...
                                        <Tooltip>
                                            ...
                                            >
                                                ...
                                                <ul className="text-label list-disc list-inside opacity-90 leading-relaxed">
                                                    {m.missing_fields.map((field, idx) => (
                                                        <li key={idx}>{field}</li>
                                                    ))}
                                                </ul>
                                            </TooltipContent>
