...
export const modelFormSchema = z.object({
  ...
  // ✅ Permitir decimales en las medidas
  height_cm: emptyStringToNull.pipe(z.coerce.number().positive().nullable()),
  shoulders_cm: emptyStringToNull.pipe(z.coerce.number().positive().nullable()),
  chest_cm: emptyStringToNull.pipe(z.coerce.number().positive().nullable()),
  bust_cm: emptyStringToNull.pipe(z.coerce.number().positive().nullable()),
  waist_cm: emptyStringToNull.pipe(z.coerce.number().positive().nullable()),
  hips_cm: emptyStringToNull.pipe(z.coerce.number().positive().nullable()),
  shoe_size_eu: emptyStringToNull.pipe(z.coerce.number().positive().nullable()),
  pants_size: emptyStringToNull.pipe(z.coerce.number().positive().nullable()),
  ...
  phone_number: emptyStringToNull.pipe(
    z.string().regex(phoneRegex, "El teléfono debe empezar con + y solo contener números.").nullable()
  ),
